...
<h2>흩어진 클릭이 모이면, 나만의 취향이 보입니다.</h2>
<h3>Algoboza는 여러 웹사이트에서 발생하는 검색, 조회, 클릭, 장바구니 등의 행동을 분석해 사용자의 관심 키워드를 발견합니다.<br>막연했던 관심사를 한눈에 확인하고, 상품부터 장소와 영상까지 취향에 꼭 맞는 새로운 콘텐츠를 추천받아 보세요.</h3>
